...
public class HWArreglos4Solucion {
    ...
    public static void main(String[] args) {
        ...
        // luego obtenemos el valor de la mayor ocurrencia (más veces repetido)
        // y el indice o posición para obtener el número más repetido
        int indice = 0; // indice del elemento con la mayor ocurrencia (más repetido)
